<!-- insert, buat table siswa dan jurusan, kemudian tambah metod tambahSiswa -->
<?php
if (isset($_POST['submit'])) {
  if (tambahSiswa($_POST) > 0) {
    ...
    document.location.href = 'index.php?page=rgs&statusTbh=success';
    </script>";
  } else {
    echo "<script>
    alert('Data Gagal Ditambah');
    document.location.href = 'index.php?page=rgs&statusTbh=gagal';
    </script>";
  }
}
?>
